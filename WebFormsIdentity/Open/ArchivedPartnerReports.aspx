<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="ArchivedPartnerReports.aspx.cs" 
    Inherits="WebFormsIdentity.Open.ArchivedPartnerReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ef:EntityDataSource ID="EntityDataSource1" runat="server"
        ...
        <WhereParameters>
            <asp:Parameter DefaultValue="true" Name="archived" Type="Boolean" />
        </WhereParameters>
    </ef:EntityDataSource>

    <asp:Label ID="HeaderLabel" runat="server" CssClass="h4">Archived Quarterly Reports</asp:Label>
    <hr />
