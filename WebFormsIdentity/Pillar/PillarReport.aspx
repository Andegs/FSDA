<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="PillarReport.aspx.cs" Inherits="WebFormsIdentity.Pillar.PillarReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="well" style="margin-bottom:20px;">
        <div style="float:left">
            <asp:Button ID="ReturnPartnerReportBtn" runat="server" Text="Return Report"
                CssClass="btn btn-info" OnClick="ReturnPartnerReportBtn_Click" />
        </div>
        <div style="float:right">
            <asp:Button ID="ApprovePartnerReportBtn" runat="server" Text="Approve Report" 
                CssClass="btn btn-primary" OnClick="ApprovePartnerReportBtn_Click" />
        </div>
