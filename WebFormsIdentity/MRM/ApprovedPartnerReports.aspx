<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="ApprovedPartnerReports.aspx.cs" 
    Inherits="WebFormsIdentity.MRM.ApprovedPartnerReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="HeaderLabel" runat="server" CssClass="h4">Approved Quarterly Reports</asp:Label>
    <hr />
